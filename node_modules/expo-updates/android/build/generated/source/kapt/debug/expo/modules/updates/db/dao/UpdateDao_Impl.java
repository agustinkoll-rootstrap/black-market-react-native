...
public final class UpdateDao_Impl extends UpdateDao {
  ...
  public UpdateDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUpdateEntity = new EntityInsertionAdapter<UpdateEntity>(__db) {
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final byte[] _tmp = __converters.uuidToBytes(entity.getId());
        if (_tmp == null) {
          statement.bindNull(1);
        } else {
          statement.bindBlob(1, _tmp);
        }
        final Long _tmp_1 = __converters.dateToLong(entity.getCommitTime());
        if (_tmp_1 == null) {
          statement.bindNull(2);
        } else {
          statement.bindLong(2, _tmp_1);
        }
        if (entity.getRuntimeVersion() == null) {
        ...
        final String _tmp_2 = __converters.jsonObjectToString(entity.getManifest());
        if (_tmp_2 == null) {
          statement.bindNull(5);
        } else {
          statement.bindString(5, _tmp_2);
        }
        if (entity.getLaunchAssetId() == null) {
          statement.bindNull(6);
        } else {
          statement.bindLong(6, entity.getLaunchAssetId());
        }
        final int _tmp_3 = __converters.statusToInt(entity.getStatus());
        statement.bindLong(7, _tmp_3);
        final int _tmp_4 = entity.getKeep() ? 1 : 0;
        statement.bindLong(8, _tmp_4);
        final Long _tmp_5 = __converters.dateToLong(entity.getLastAccessed());
        if (_tmp_5 == null) {
          statement.bindNull(9);
        } else {
          statement.bindLong(9, _tmp_5);
        }
        statement.bindLong(10, entity.getSuccessfulLaunchCount());
        statement.bindLong(11, entity.getFailedLaunchCount());
      }
    };
  ...
  public List<UUID> loadRecentUpdateIdsWithFailedLaunch() {
    final String _sql = "SELECT id FROM updates WHERE failed_launch_count > 0 ORDER BY commit_time DESC LIMIT 5;";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
