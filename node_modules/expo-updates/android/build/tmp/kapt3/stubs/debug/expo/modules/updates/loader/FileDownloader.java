...
public final class FileDownloader {
    ...
    private final void downloadAssetAndVerifyHashAndWriteToPath(okhttp3.Request request, java.lang.String expectedBase64URLEncodedSHA256Hash, java.io.File destination, expo.modules.updates.loader.FileDownloader.FileDownloadCallback callback) {
    }
    ...
    private final void parseMultipartRemoteUpdateResponse(okhttp3.ResponseBody responseBody, expo.modules.updates.manifest.ResponseHeaderData responseHeaderData, java.lang.String boundary, expo.modules.updates.loader.FileDownloader.RemoteUpdateDownloadCallback callback) {
    }
    
    private final void parseDirective(expo.modules.updates.manifest.ResponsePartInfo directiveResponsePartInfo, java.lang.String certificateChainFromManifestResponse, expo.modules.updates.loader.FileDownloader.ParseDirectiveCallback callback) {
    }
    
    private final void parseManifest(expo.modules.updates.manifest.ResponsePartInfo manifestResponseInfo, org.json.JSONObject extensions, java.lang.String certificateChainFromManifestResponse, expo.modules.updates.loader.FileDownloader.ParseManifestCallback callback) {
    }
    
    public final void downloadRemoteUpdate(@org.jetbrains.annotations.Nullable()
    ...
    private final void downloadData(okhttp3.Request request, okhttp3.Callback callback) {
    }
    ...
    public static final class Companion {
        ...
        private final void checkCodeSigningAndCreateManifest(java.lang.String bodyString, org.json.JSONObject preManifest, expo.modules.updates.manifest.ResponseHeaderData responseHeaderData, expo.modules.updates.manifest.ResponsePartHeaderData responsePartHeaderData, org.json.JSONObject extensions, java.lang.String certificateChainFromManifestResponse, expo.modules.updates.UpdatesConfiguration configuration, expo.modules.updates.logging.UpdatesLogger logger, expo.modules.updates.loader.FileDownloader.ParseManifestCallback callback) throws java.lang.Exception {
        }
        ...
        @org.jetbrains.annotations.NotNull()
        public final okhttp3.Request createRequestForRemoteUpdate$expo_updates_debug(@org.jetbrains.annotations.Nullable()
        org.json.JSONObject extraHeaders, @org.jetbrains.annotations.NotNull()
        expo.modules.updates.UpdatesConfiguration configuration, @org.jetbrains.annotations.NotNull()
        android.content.Context context) {
            return null;
