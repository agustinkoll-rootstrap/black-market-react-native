 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.blackmarket.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.blackmarket'; // ios bundle id
const PACKAGE = 'com.blackmarket'; // android package name
const NAME = 'BlackMarket'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = '72fdf440-59f1-493d-96e3-4afad8d7a045'; // eas project id
const SCHEME = 'BlackMarket'; // app scheme
